...
data <- raiseCompare(nYears,baseSalary,stayRaise,promotionYears,promotionRaise,jumpYears,jumpRaise,inflation)
newdata=melt(data,id='year',variable_name='Action')
qplot(year,value,data=newdata,geom="line",color=Action,main="Salary Comparison",size=I(1.5))